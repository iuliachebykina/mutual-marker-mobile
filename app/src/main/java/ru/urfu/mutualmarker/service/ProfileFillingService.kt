...
class ProfileFillingService {
    ...
    fun fillSelfProfile(profileService: ProfileService, view: View) {
        val myProfileResponse: Call<MyProfile> = profileService.getStudentProfile()
        myProfileResponse.enqueue(object : Callback<MyProfile> {
