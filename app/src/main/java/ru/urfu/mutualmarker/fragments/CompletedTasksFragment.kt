...
class CompletedTasksFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //getTasks(view)
        recyclerView = view.findViewById(R.id.recycle_completed_tasks) as RecyclerView
    ...
    private fun getTasks() {
        ...
        taskService.getCompletedTasks(roomId, 0, 10).enqueue(object : Callback<List<TaskInfo>> {
